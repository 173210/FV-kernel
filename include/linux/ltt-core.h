...
struct ltt_traces {
	...
	unsigned int num_start_trig_u_traces;	/* Number of traces having start trigger user strings */
	unsigned int num_stop_trig_u_traces;	/* Number of traces having stop trigger user strings */
