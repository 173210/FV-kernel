 ...
 *
 */
#ifndef __ASM_TX_BOARDS_TX4939_H
#define __ASM_TX_BOARDS_TX4939_H

#include <asm/tx-boards/tx4938.h>	/* some controllers are compatible with 4927/4938 */

#ifdef CONFIG_64BIT
#define TX4939_REG_BASE	0xffffffffff1f0000UL /* == TX4938_REG_BASE */
#else
#define TX4939_REG_BASE	0xff1f0000 /* == TX4938_REG_BASE */
#endif
...
#define TX4939_PIO_REG		(TX4939_REG_BASE + 0xf500)
...
typedef __u32 __u32a8 __attribute__ ((__aligned__(8)));
...
struct tx4939_ddrc_reg {
	...
	volatile __u64 unused0[17];
	volatile __u64 winen;
	volatile __u64 win[4];
};

struct tx4939_ndfmc_reg {
	struct tx4939_le_reg dtr;
	struct tx4939_le_reg mcr;
	struct tx4939_le_reg sr;
	struct tx4939_le_reg isr;
	struct tx4939_le_reg imr;
	struct tx4939_le_reg spr;
};
...
struct tx4939_ccfg_reg {
	...
	volatile __u64 ramp;
	volatile __u64 unused2[2];
	volatile __u64 dskwctrl;
	volatile __u64 mclkosc;
	volatile __u64 mclkctl;
	volatile __u64 unused3[17];
	struct {
		volatile __u64 mr;
		volatile __u64 dr;
	} gpio[2];
...
struct tx4939_vpc_desc {
	volatile __u32 src;
	volatile __u32 next;
	volatile __u32 ctrl1;
	volatile __u32 ctrl2;
};
...
#define tx4939_ddrcptr	((struct tx4939_ddrc_reg *)TX4939_DDRC_REG)
#define tx4939_ebuscptr		tx4938_ebuscptr
#define tx4939_dmaptr(ch)	((struct tx4927_dma_reg *)TX4939_DMA_REG(ch))
#define tx4939_ndfmcptr		((struct tx4939_ndfmc_reg *)TX4939_NDFMC_REG)
#define tx4939_ircptr		((struct tx4939_irc_reg *)TX4939_IRC_REG)
#define tx4939_pcicptr		tx4938_pcicptr
#define tx4939_pcic1ptr		tx4938_pcic1ptr
#define tx4939_ccfgptr		((struct tx4939_ccfg_reg *)TX4939_CCFG_REG)
#define tx4939_tmrptr(ch)	((struct txx9_tmr_reg *)TX4939_TMR_REG(ch))
#define tx4939_sioptr(ch)	((struct txx9_sio_reg *)TX4939_SIO_REG(ch))
#define tx4939_aclcptr		tx4938_aclcptr
#define tx4939_spiptr		tx4938_spiptr
#define tx4939_sramcptr		tx4938_sramcptr
#define tx4939_rtcptr		((struct tx4939_rtc_reg *)TX4939_RTC_REG)
#define tx4939_cryptoptr	((struct tx4939_crypto_reg *)TX4939_CRYPTO_REG)
#define tx4939_vpcptr	((struct tx4939_vpc_reg *)TX4939_VPC_REG)

#define TX4939_REV_MAJ_MIN()	((__u32)txx9_read64(&tx4939_ccfgptr->crir) & 0x00ff)
#define TX4939_REV_PCODE()	((__u32)txx9_read64(&tx4939_ccfgptr->crir) >> 16)
#define TX4939_CCFG_BCFG()	((__u32)((txx9_read64(&tx4939_ccfgptr->ccfg) & TX4939_CCFG_BCFG_MASK) >> 32))
...
#endif /* __ASM_TX_BOARDS_TX4939_H */
