...
/*
 * mx53_fv40_pmic_da9053.c  --  i.MX53 FV40 driver for pmic da9053
 */
...
#define MX53_FV40_WiFi_BT_PWR_EN		IMX_GPIO_NR(3, 10)	/*GPIO_3_10 */
struct regulator_init_data fv40_wifi_bt_reg_initdata = {
	.constraints = {
...
static struct fixed_voltage_config wifi_bt_reg_config = {
	.supply_name		= "wifi_bt",
	.microvolts		= 3300000,
	.gpio			= MX53_FV40_WiFi_BT_PWR_EN,
	.enable_high		= 1,
	.enabled_at_boot	= 0,
	.init_data		= &fv40_wifi_bt_reg_initdata,
};

static struct platform_device fv40_wifi_bt_reg_device = {
...
static void da9052_init_ssc_cache(struct da9052 *da9052)
{
	...
	da9052->ssc_cache[DA9052_LDO1_REG].type = VOLATILE;
	da9052->ssc_cache[DA9052_LDO6_REG].type = VOLATILE;
...
#define MX53_FV40_DA9052_IRQ			(6*32 + 11)	/* GPIO7_11 */

static int __init fv40_da9052_init(struct da9052 *da9052)
{
	...
	set_irq_type(gpio_to_irq(MX53_FV40_DA9052_IRQ), IRQF_TRIGGER_LOW);

	da9052_init_ssc_cache(da9052);
#ifdef CONFIG_SND_SOC_SGTL5000
	platform_device_register(&sgtl5000_reg_devices);
#endif
	ret = platform_device_register(&fv40_wifi_bt_reg_device);

	return 0;
}

static struct da9052_platform_data __initdata da9052_plat = {
	.init = fv40_da9052_init,
...
static struct i2c_board_info __initdata da9052_i2c_device = {
	...
	.irq = gpio_to_irq(MX53_FV40_DA9052_IRQ),
	.platform_data = &da9052_plat,
};

int __init mx53_fv40_init_da9052(void)
{
