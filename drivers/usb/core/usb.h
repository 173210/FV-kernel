...
extern void set_hub_port_power_status(struct usb_device *udev, unsigned long ppc_on, unsigned long ppc_off);
...
extern void set_hub_port_test_status(struct usb_device *udev, unsigned int test_mode);
