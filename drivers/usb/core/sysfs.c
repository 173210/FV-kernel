...
static ssize_t
store_overcurret_field(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
...
static ssize_t
store_port_status(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
	struct usb_interface *intf;
	struct usb_device *udev;
...
static ssize_t
store_port_test(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
	struct usb_interface *intf;
	struct usb_device *udev;
...
int usb_create_sysfs_port_status_files (struct device *dev)
{
	...
	return ret;
#else  /* CONFIG_USB_TEST_ENHANCEMENT */
