...
/* Patch for NEC FOMA N900i */
UNUSUAL_DEV(  0x0409, 0x0113, 0x0100, 0x0100,
		"NEC",
		"FOMA N900i",
		US_SC_DEVICE, US_PR_DEVICE, NULL,
		US_FL_FIX_INQUIRY),

/* Patch for NEC FOMA N900iS */
UNUSUAL_DEV(  0x0409, 0x0122, 0x0100, 0x0100,
		"NEC",
		"FOMA N900iS",
		US_SC_DEVICE, US_PR_DEVICE, NULL,
		US_FL_FIX_INQUIRY),

UNUSUAL_DEV(  0x0411, 0x0043, 0x0000, 0x0000,
		"WDC WD16",
		"00JB-00GVA0",
		US_SC_DEVICE, US_PR_DEVICE, NULL,
		US_FL_FIX_INQUIRY),
